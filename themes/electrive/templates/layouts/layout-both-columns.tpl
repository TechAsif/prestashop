...
<body id="{$page.page_name}"
  class="{$page.body_classes|classnames} {if isset($WB_mainLayout)}{$WB_mainLayout}{/if} {if isset($WB_darklightLayout)}{$WB_darklightLayout}{/if} {if isset($WB_showDarkLightMenu)}{$WB_showDarkLightMenu}{/if}">
