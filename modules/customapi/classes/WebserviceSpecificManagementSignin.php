...
class WebserviceSpecificManagementSignin implements WebserviceSpecificManagementInterface
{
	...
	$tempEmail = $this->wsObject->urlFragments['email'];

	if (strpos($tempEmail, '@') === false) {
	    $tempEmail = $tempEmail . '@letsgobd.com';
	}

        $customer = new Customer();
        $customer->getByEmail($tempEmail, $this->wsObject->urlFragments['passwd']);
