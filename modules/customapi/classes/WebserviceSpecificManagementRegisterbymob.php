...
class WebserviceSpecificManagementRegisterbymob implements WebserviceSpecificManagementInterface
{
	...
	$customer->phone_mobile = $this->wsObject->urlFragments['phone_mobile'];

	if (strlen(trim($customer->email)) < 1 ) $customer->email = $customer->phone_mobile . '@letsgobd.com'  ;
