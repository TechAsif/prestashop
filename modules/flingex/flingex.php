...
class Flingex extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->flingex_api = new FlingexApi($this);
    ...
    public function hookActionValidateOrder($params)
    {
        ...
        $order = $params['order'];
        $api_response = $this->flingex_api->sentOrderToFlingex($order);
        
        $tracking_id = (isset($api_response['tracking_id']) && $api_response['tracking_id']) ? $api_response['tracking_id'] : null;
        
        $tracking_response = $this->flingex_api->sentOrderToFlingexTrackingApi($tracking_id);
...
//        var_dump($html);
    ...
    public function getContent()
    {
        ...
        switch ($view_mode) {
            ...
            default:
                ...
                $html .= $this->displayFlingexSettings();
                break;
        }
        return $html;
    }
    ...
    protected function displayFlingexSettings()
    {
    ...
    public function postProcess()
    {
        ...
        if (Tools::isSubmit('submitAddDHLDP_dhl_configure')) {
            ...
            if (count($form_errors) == 0) {
                ...
                $check_client = $this->flingex_api->checkAccount( $dhl_live_user, $dhl_live_sign);
