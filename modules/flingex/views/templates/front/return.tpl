...
{block name='page_title'}
    {l s='Return DHL Label' mod='paperfly'}
{/block}
...
{block name='page_content'}
        ...
        <aside id="notifications">
            <div class="container">
                <article class="alert alert-danger" role="alert" data-alert="danger">
                    <ul>
                        <li> {l s='You cannot create DHL return label. Please contact us.' mod='paperfly'}</li>
                    </ul>
                </article>
    ...
    {if isset($show_form) && ($show_form == true)}
        <div class="dhl-return-label-form">
            <h6>{l s='Here is a form for creating return label. Please fill sender address' mod='paperfly'}</h6>
            <form action="{$link->getModuleLink('dhldp', 'return', ['id_order_return' => $id_order_return], true)|escape:'html':'UTF-8'}" method="post" id="dhl_return">
                <section class="form-fields">
                    <div class="form-group row">
                        <label class="col-md-3 form-control-label">{l s='Name 1' mod='paperfly'}</label>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-3 form-control-comment">
                            {l s='it will be printed on label' mod='paperfly'}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 form-control-label">{l s='Name 2' mod='paperfly'}</label>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-3 form-control-comment">
                            {l s='optional' mod='paperfly'}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 form-control-label">{l s='Name 3' mod='paperfly'}</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 form-control-label">{l s='Street' mod='paperfly'}</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 form-control-label">{l s='House number' mod='paperfly'}</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 form-control-label">{l s='Postcode' mod='paperfly'}</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 form-control-label">{l s='City' mod='paperfly'}</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 form-control-label">{l s='State' mod='paperfly'}</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 form-control-label">{l s='Country' mod='paperfly'}</label>
                        <div class="col-md-6">
                ...
                <footer class="form-footer clearfix">
                    ...
                    <button type="submit" name="submitCreateLabel" id="submitCreateLabel" class="btn btn-primary pull-xs-right">{l s='Create' mod='paperfly'}</button>
                </footer>
            </form>
        </div>
    {/if}
    {if isset($show_label) && ($show_label == true)}
        <div class="dhl-return-label-form">
        <h6>{l s='Return label has been generated. Please click on "Get return label" for downloading label PDF file.' mod='paperfly'}</h6>
        <form action="{$link->getModuleLink('dhldp', 'return', ['id_order_return' => $id_order_return], true)|escape:'html':'UTF-8'}" method="post" id="dhl_return">
            <footer class="form-footer clearfix">
                {if isset($id_order_return)}<input type="hidden" name="id_order_return" value="{$id_order_return|intval}" />{/if}
                <input type="hidden" name="token" value="{$token}" />
                <button type="submit" name="submitGetLabel" id="submitGetLabel" class="btn btn-primary">{l s='Get Return label' mod='paperfly'}</button>
            </footer>
        </form>
        </div>
    {/if}
    <ul class="footer_links clearfix">
        <li>
            <a class="btn btn-defaul button button-small" href="{$link->getPageLink('order-follow', true)|escape:'html':'UTF-8'}">
                <span><i class="icon-chevron-left"></i> {l s='Return Merchandise Authorization (RMA)' mod='paperfly'}</span>
            </a>
        </li>
    </ul>
{/block}