...
<div class="row dhl_q" style="display:none">
	<div class="col-xs-9 col-sm-9 col-md-9">
		<button type="button" class="button btn btn-default button-medium findShopMap"><span>{l s='Find Shop' mod='paperfly'}</span></button>
	</div>
</div>
<div class="row dhl_map" style="">
	...
	<div class="col-xs-3 col-sm-3 col-md-3">
		<div class="form-group">
			<label for="dhl_zip">{l s='Zip/Postal code' mod='paperfly'}<sup>*</sup></label>
		...
		{*<div class="form-group">
			<label for="id_country">{l s='Country' mod='paperfly'}<sup>*</sup></label>
		...
		<button type="button" class="button btn btn-default button-medium findShop"><span>{l s='Search' mod='paperfly'}</span></button>
