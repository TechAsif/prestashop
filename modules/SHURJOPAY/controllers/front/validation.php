...
// 		echo $tran_id."----".$order_id."----".$val_id;exit;
        ...
        $failed_URL = Tools::getHttpHost( true ).__PS_BASE_URI__.'en/cart?action=show';
        $success_URL = Tools::getHttpHost( true ).__PS_BASE_URI__.'en/order-history';
