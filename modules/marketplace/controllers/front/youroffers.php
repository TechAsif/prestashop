...
class MarketplaceYouroffersModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        if (isset($this->context->customer->id)) {
            ...
            if ($seller && $seller['active']) {
                ...
                $sellerProduct = WkMpSellerProduct::getSellerOffersProduct($seller['id_seller'], 'all', $idLang);
                if ($sellerProduct) {
                ...
                $specificAllProduct = WkMpSellerProduct::getAllSpecificProduct();
                ...
                $this->context->smarty->assign(array(
                    ...
                    'specificAllProduct' => $specificAllProduct,
                ));

                $this->defineJSVars();
                $this->setTemplate('module:marketplace/views/templates/front/product/youroffers.tpl');
            } else {
