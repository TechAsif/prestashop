...
returning it can be avoided' mod='dhldp'}</span>
                ...
                <div class="col-lg-6">
                    <div class="row form-wrapper form-horizontal">
                        ...
                        <div class="form-group{if $is177} form_group177 col-lg-12{/if}">
                            <label class="control-label col-lg-6">{l s='Preferred location' mod='dhldp'}</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group{if $is177} form_group177 col-lg-12{/if}">
                            <label class="control-label col-lg-6">{l s='Preferred neighbour' mod='dhldp'}</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group{if $is177} form_group177 col-lg-12{/if}">
                            <label class="control-label col-lg-6">{l s='Preferred day' mod='dhldp'}</label>
                            <div class="col-lg-6">
